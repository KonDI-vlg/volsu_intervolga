    ...
    <div class="row">
        <div class="col-12">
            <form method="post">
                ...
                <select style="margin-top:10px;" name="gender" class="form-select" aria-label="Default select example">
                ...
                <label for="exampleFormControlInput6" class="form-label">Ссылка на профиль Вконтакте</label>
                ...
                <select style="margin-top:10px;" name="blood" class="form-select" aria-label="Default select example">
                ...
                <select style="margin-top:10px;" name="blood_rh" class="form-select" aria-label="Default select example">
